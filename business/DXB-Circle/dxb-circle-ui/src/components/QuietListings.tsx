              ...
              {[1, 2, 3].map((number) => (
                <div key={number} className="flex items-center">
                  <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-medium ${
                    step >= number ? 'bg-gold-500 text-white' : 'bg-slate-700 text-slate-400'
                  }`}>
                  ...
                  <div className="bg-gradient-to-r from-slate-700 to-slate-600 p-6 rounded-xl border border-slate-500">
                    <div className="flex items-start justify-between mb-4">
                      ...
                      <div className="text-right">
                        ...
                        <div className="text-sm text-slate-400">2BR Penthouse</div>
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-3 gap-4 mb-6">
                      <div className="text-center">
                        ...
                        <div className="text-xs text-slate-400">Est. Net Yield</div>
                      </div>
                      <div className="text-center">
                        <div className="text-lg font-bold text-white">Q2 2026</div>
                        <div className="text-xs text-slate-400">Handover</div>
                      </div>
                      <div className="text-center">
                        <div className="text-lg font-bold text-white">5% Down</div>
                        <div className="text-xs text-slate-400">Payment Plan</div>
                      </div>
                    </div>
